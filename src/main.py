...
def main(cfg: DictConfig) -> None:
    ...
    try:
        rprint("[blue]Starting Handwriting Analysis Experiment[/blue]")
        ...
        rprint(f"Number of features: {data_module.get_feature_dim()}")
        rprint(f"Number of tasks: {data_module.get_num_tasks()}")
